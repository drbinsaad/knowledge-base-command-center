...
On a narrow phone screen, selecting a record opens a focused detail view with its title and **Back to main page** control kept visible. The detail content scrolls independently above Obsidian's mobile navigation; **Back to main page** or Escape returns to the same row and list position. Desktop keeps the side-by-side index and inspector.
