...
export const UPDATE_ANNOUNCEMENT_0_25_0: UpdateAnnouncement = {
  ...
  intro: "Easier to use: attach any file, clearer names and messages, and a faster view. Physical iPhone/iPad testing remains unverified.",
  highlights: [
    ...
    "Typing in a note outside your knowledge bases no longer redraws the whole view.",
